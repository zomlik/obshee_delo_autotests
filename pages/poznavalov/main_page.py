...
class MainPage(BasePage):
    ...
    def click_support_button(self):
        return self.clicable(MainPageLocators.HEADER_SUPPORT_BUTTON).click()

    def click_once_time_button(self):
        return self.clicable(MainPageLocators.ONE_SUPPORT).click()
    ...
    def check_pay_button(self):
        return self.visible(MainPageLocators.PAY_BUTTON)
